...
const Profile = ({profile}) => {
  return (
    <div className='flex justify-center w-full mt-10'>
      {profile ? (
        <div className='md:w-3/4 sm:w-3/4 w-7/8 min-h-50 flex min-[400px]:flex-row flex-col items-center gap-5 border border-white/30 bg-white/10 p-4 rounded-2xl backdrop-blur-sm hover:-translate-y-1 hover:scale-[1.01] transition-all duration-100' >
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='sm:flex gap-2 flex flex-col'>
              ...
              items-center max-[350px]:flex-col'>
                <p>Followers</p>
